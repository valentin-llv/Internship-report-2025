...
#figure(
	image("../../../assets/logo/CSEP.png", height: 60mm),
	caption: [
		Logo du CSEP
	],
)
...
#figure(
    ...
    image("../../../assets/logo/IonSat.png", height: 44mm),
    image("../../../assets/logo/X-Rocket.png", height: 44mm),
    image("../../../assets/logo/Ballon.png", height: 44mm)
  ),
	caption: [
		Stickers des activités du CSEP
	],
)