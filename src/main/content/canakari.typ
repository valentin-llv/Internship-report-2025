...
*Débogage :* L'IP propose également des signaux de débogage, dont un signal contenant le status de la machine à états, un signal indiquant les ticks du prescaler.
  ...
  [
#figure(
	image("../../../assets/images/Canakari interface.png", height: 100mm),
	caption: [
		Interface de\ l'IP Canakari
	],
)
  ]
)
...
#figure(
	image("../../../assets/images/Canakri register bank.png", height: 172mm),
	caption: [
		Banque de registres de l'IP Canakari
	],
)
